...
bjetNN= cms.EDProducer("BJetEnergyRegressionMVA",
    ...
    weightFile =  cms.FileInPath("PhysicsTools/NanoAOD/files/breg_training_2018.pb"),
...
### bjetNN modifications
#
# NanoAOD v6 uses the following era modifiers:
# - Run2_2016,run2_nanoAOD_94X2016
# - Run2_2017,run2_nanoAOD_94XMiniAODv2
# - Run2_2018,run2_nanoAOD_102Xv1
# Will modify the first two to use proper bregression
#
run2_nanoAOD_94X2016.toModify( bjetNN, weightFile = cms.FileInPath("PhysicsTools/NanoAOD/files/breg_training_2016.pb") )
run2_nanoAOD_94X2016.toModify( bjetNN,outputFormulas = cms.vstring(["at(0)*0.31976690888404846+1.047176718711853","0.5*(at(2)-at(1))*0.31976690888404846"]))

run2_nanoAOD_94XMiniAODv2.toModify( bjetNN, weightFile = cms.FileInPath("PhysicsTools/NanoAOD/files/breg_training_2017.pb") )
run2_nanoAOD_94XMiniAODv2.toModify( bjetNN,outputFormulas = cms.vstring(["at(0)*0.28225210309028625+1.055067777633667","0.5*(at(2)-at(1))*0.28225210309028625"]))
